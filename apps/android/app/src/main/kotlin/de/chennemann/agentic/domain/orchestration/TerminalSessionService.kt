...
data class TerminalContext(val baseUrl: String, val token: String, val threadId: String, val cwd: String)
...
class TerminalSessionService(
    ...
    override suspend fun context(threadId: String): TerminalContext {
        ...
        return TerminalContext(environment.baseUrl, token, threadId, thread.worktreePath ?: project.workspaceRoot)
    }
    ...
    override suspend fun open(context: TerminalContext, terminalId: String) =
        rpc.openTerminal(context.baseUrl, context.token, context.threadId, terminalId, context.cwd)
    ...
    override suspend fun restart(context: TerminalContext, terminalId: String) =
        rpc.restartTerminal(context.baseUrl, context.token, context.threadId, terminalId, context.cwd)
