...
class ConversationViewModelTest {
    ...
    fun mapsServiceStateOnInjectedDispatcher() = runTest(TestCoroutineScheduler()) {
        ...
        service.state.value = state(
            ...
            focusedMessages = listOf(
                de.chennemann.agentic.domain.session.MessageState(id = "u1", role = "user", text = "Hi", sort = "1"),
                de.chennemann.agentic.domain.session.MessageState(id = "a1", role = "assistant", text = "Hello", sort = "2"),
            ),
    ...
    private fun state(
        ...
        focusedMessages: List<de.chennemann.agentic.domain.session.MessageState> = emptyList(),
