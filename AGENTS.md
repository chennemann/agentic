...
base64 app/release.keystore | gh secret set ANDROID_KEYSTORE_BASE64 && gh secret set ANDROID_KEYSTORE_PASSWORD -b"changeit" && gh secret set ANDROID_KEY_ALIAS -b"agentic" && gh secret set ANDROID_KEY_PASSWORD -b"changeit"  # Upload signing secrets for GitHub Actions
...
3. **Release APKs must be signed in CI** – Configure `ANDROID_KEYSTORE_BASE64`, `ANDROID_KEYSTORE_PASSWORD`, `ANDROID_KEY_ALIAS`, `ANDROID_KEY_PASSWORD` GitHub secrets
